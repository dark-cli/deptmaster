...
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `assert_receiver_is_total_eq`, `assert_receiver_is_total_eq`, `assert_receiver_is_total_eq`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `from`, `from`, `from`, `from`, `from`, `from`, `hash`
...
enum Currency {
  ...
  Future<void> asStr() => RustLib.instance.api.crateTypesModelsCurrencyAsStr(
        that: this,
      );

  static Future<Currency> default_() =>
      RustLib.instance.api.crateTypesModelsCurrencyDefault();

  static Future<Currency?> fromStr({required String s}) =>
      RustLib.instance.api.crateTypesModelsCurrencyFromStr(s: s);
}
