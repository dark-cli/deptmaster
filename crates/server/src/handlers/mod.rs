...
pub use wallets::{
    ...
    delete_user_group, delete_wallet, get_member_permissions, get_my_permissions, get_my_wallet_settings,
    get_permission_matrix, get_wallet, get_wallet_permissions, join_wallet_by_code,
    list_contact_group_members, list_contact_groups, list_permission_actions,
    list_user_group_members, list_user_groups, list_user_wallets, list_wallet_users,
    list_wallets, put_my_wallet_settings, put_permission_matrix, remove_contact_group_member,
    remove_user_from_wallet, remove_user_group_member, search_wallet_users, set_member_permissions,
    set_wallet_permissions, update_contact_group, update_user_group, update_wallet, update_wallet_user,
};
